/******/ (() => { // webpackBootstrap
    ...
    var KTDatatablesSearchOptionsAdvancedSearch = function () {
        ...
        var initTable1 = function () {
            // begin first table
            var table = $('#kt_datatable_income_dpb_invoice_success').DataTable({
                responsive: true,
                // Pagination settings
        ...
        var initTable2 = function () {
            // begin first table
            var table = $('#kt_datatable_income_dpb_invoice_warning').DataTable({
                responsive: true,
                // Pagination settings
                dom: `<'row'<'col-sm-12'tr>>
			<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
        ...
        var initTable3 = function () {
            // begin first table
            var table = $('#kt_datatable_income_dpb_invoice_danger').DataTable({
                responsive: true,
                // Pagination settings
                dom: `<'row'<'col-sm-12'tr>>
			<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
