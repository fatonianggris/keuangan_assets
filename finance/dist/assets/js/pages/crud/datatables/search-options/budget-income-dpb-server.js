var KTDatatablesSearchOptionsAdvancedSearch = function () {
	...
	var initTable1 = function () {
		...
		// begin first table
		var table = $('#kt_datatable_income_dpb').DataTable({
			responsive: true,
			// Pagination settings
			...
			checkbox: true,
			ajax: {
				url: HOST_URL + 'finance/income/income/get_data_income_dpb',
				type: 'POST',
				data: {
			...
			columns: [
				{ data: 'id_tagihan_pembayaran_dpb' },
				{ data: 'id_invoice' },
								...
								return `<div class="dropdown dropdown-inline">
									...
									<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
										<ul class="nav nav-hover flex-column">
											<li class="nav-item"><a class="nav-link" href="`+ HOST_URL + `finance/income/detail_income_dpb/` + full.id_encrypt + `"><i class="nav-icon fas fa-eye"></i><span class="nav-text text-hover-primary font-weight-bold">Lihat Detail</span></a></li>
										</ul>
										<ul class="nav nav-hover flex-column">
											<li class="nav-item"><a class="nav-link text-warning" href="`+ HOST_URL + `finance/income/edit_income_dpb/` + full.id_encrypt + `"><i class="nav-icon fas fa-pen text-warning"></i><span class="nav-text text-hover-primary font-weight-bold text-warning">Edit Tagihan</span></a></li>
										</ul>
										<ul class="nav nav-hover flex-column">
