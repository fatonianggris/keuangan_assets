			...
			<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
				...
				columnDefs: [
					...
					},
					{
						...
						render: function (data, type, full, meta) {
							var status = {
								1: { 'title': 'KB', 'class': ' label-light-default' },
								2: { 'title': 'TK', 'class': ' label-light-info' },
								3: { 'title': 'SD', 'class': ' label-light-primary' },
								4: { 'title': 'SMP', 'class': ' label-light-success' },
								5: { 'title': 'SMA', 'class': ' label-light-warning' },
								6: { 'title': 'UMUM', 'class': ' label-light-grey' },
							};
							if (typeof status[data] === 'undefined' || typeof status[data] === null) {
								return '<span class="label label-lg font-weight-bold label-light-danger label-inline">KOSONG</span>';
							}
