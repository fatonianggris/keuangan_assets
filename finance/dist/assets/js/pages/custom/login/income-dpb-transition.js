$(document).ready(function () {
	...
	$("#kt_datatable_income_dpb_invoice_success").on("click", ".edit_income_transition_dpb", function () {
		...
		$.ajax({
			...
			success: function (data) {
				if (data.status) {
					...
					$("#modal_dpb").html("<div class='alert alert-danger text-center font-weight-bold' role='alert'>"
		...
		$('#kt_edit_income_dpb_transaction').attr('action', `${HOST_URL}finance/income/update_income_dpb_transition/` + id_tagihan);

		$("#modalEditDPBTransition").modal("show");
	...
	$("#kt_datatable_income_dpb_invoice_success").on("click", ".delete_income_transition_du", function () {
		...
		Swal.fire({
			...
			closeOnCancel: true,
			html: "Apakah anda yakin ingin menghapus Tagihan DPB <b>" + id_invoice + "</b> atas nama <b>'" +
			...
			if (result.value) {
				$.ajax({
					type: "post",
					url: `${HOST_URL}/finance/income/delete_income_dpb_transition`,
					data: {
