/******/ (() => { // webpackBootstrap
	...
	var KTLogin = function () {
		...
		var _handleSignInForm = function () {
			var validation;
			var edit_button = document.querySelectorAll('.edit_income_transition_dpb');
			var form = KTUtil.getById('kt_edit_income_dpb_transaction');
						...
						id_invoice: {
							validators: {
								...
								remote: {
									...
									method: 'POST',
									url: HOST_URL + 'finance/income/income/check_invoice_number_dpb_transition',
									data: function () {
										return {
						...
						nomor_bayar: {
							validators: {
								...
								remote: {
									...
									method: 'POST',
									url: HOST_URL + 'finance/income/income/check_payment_number_dpb_transition',
									data: function () {
										return {
						...
						nama: {
							validators: {
								...
								remote: {
									...
									method: 'POST',
									url: HOST_URL + 'finance/income/income/check_name_dpb_transition',
									data: function () {
										return {
