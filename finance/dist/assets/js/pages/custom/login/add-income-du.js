/******/ (() => { // webpackBootstrap
	...
	var KTLogin = function () {
		...
		var _handleSignInForm = function () {
			var validation;
			var status = true;
			var form = KTUtil.getById('kt_add_income_du_form');
						...
						nomor_invoice: {
							validators: {
								...
								remote: {
									...
									method: 'POST',
									url: HOST_URL + 'finance/income/income/check_invoice_number_du_add',
									data: function () {
										return {
						...
						nomor_pembayaran: {
							validators: {
								...
								remote: {
									...
									method: 'POST',
									url: HOST_URL + 'finance/income/income/check_payment_number_du_add',
									data: function () {
										return {
