/******/ (() => { // webpackBootstrap
	...
	var KTLogin = function () {
		var _import_employee;

		var _handleEmployeeForm = function () {
			var validation;
			var form = KTUtil.getById('kt_upload_nasabah_employee')
			...
			_import_employee.on('submit', function (wizard) {
		...
		return {
			// public functions
			init: function () {
				_import_employee = $('#kt_upload_nasabah_employee');
				_handleEmployeeForm();
			}
		};
	}();
